using Nullframes.Threading.Coroutines;
using Nullframes.Threading.Tasks;
using System;
...
namespace Nullframes.Threading
{
    public sealed partial class Dispatcher : IDisableCallback
    {
        ...
        /// <footer><a href="https://johnbaracuda.com/dispatcher.html#coroutines">Documentation</a></footer>
        public static void Invoke(IEnumerator enumerator, CancellationToken ct)
        {
            Invoke(() =>
            {
        ...
        /// <exception cref="InvalidCastException"></exception>
        /// <footer><a href="https://johnbaracuda.com/dispatcher.html#coroutines">Documentation</a></footer>
        public static void Invoke(IEnumerator enumerator, ExecutionCycle cycle, CancellationToken ct)
        {
            Invoke(() =>
            {
                if (ct.IsCancellationRequested)
        ...
        /// <exception cref="InvalidCastException"></exception>
        /// <footer><a href="https://johnbaracuda.com/dispatcher.html#coroutines">Documentation</a></footer>
        public static void Invoke(IEnumerator enumerator, MonoBehaviour target, CancellationToken ct)
        {
            Invoke(() =>
            {
                if (ct.IsCancellationRequested)
        ...
        /// <exception cref="InvalidCastException"></exception>
        /// <footer><a href="https://johnbaracuda.com/dispatcher.html#coroutines">Documentation</a></footer>
        public static void Invoke(IEnumerator enumerator, ExecutionCycle cycle, MonoBehaviour target, CancellationToken ct)
        {
            Invoke(() =>
            {
                if (ct.IsCancellationRequested)
