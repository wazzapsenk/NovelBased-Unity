...
{
    public class SameGenderRuleNode : INode
    {
        protected override string DOCUMENTATION => "https://www.wlabsocks.com/wiki/index.php/Same_Gender_Node";
        ...
        public override void Draw()
        {
            ...
            var inputPort = this.CreatePort("In", typeof(bool), Orientation.Horizontal, Direction.Input,
                Port.Capacity.Multi);
            inputPort.tooltip = "Checks whether the Conspirator and the Target are of the same gender.";
            inputContainer.Add(inputPort);
            
            var dualPort = this.CreatePort("[Dual]", typeof(bool), Orientation.Horizontal, Direction.Input,
                Port.Capacity.Multi);
            dualPort.tooltip = "Checks whether the Primary Actor and the Secondary Actor are of the same gender.";
