...
{
    public class GetTableVariableNode : INode
    {
        protected override string DOCUMENTATION => "https://www.wlabsocks.com/wiki/index.php/Get_Table_Variable_Node";
        ...
        public override void Draw()
        {
            ...
            var titleLabel = IEGraphUtility.CreateLabel("<color=#CCC377>\u25CF</color> Get Variable<size=12> | Table");
