...
{
    public class AddPolicyNode : INode
    {
        protected override string DOCUMENTATION => "https://www.wlabsocks.com/wiki/index.php/Add_Policy_Node";
        ...
        public override void Draw()
        {
            ...
            policyList.AddClasses("ide-node__add-policy-dropdown-field");
