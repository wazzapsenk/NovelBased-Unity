...
{
    public class BreakSequencerNode : INode
    {
        protected override string DOCUMENTATION => "https://www.wlabsocks.com/wiki/index.php/Break_Sequencer_Node";
        ...
        {
            base.Draw();
            var titleLabel = IEGraphUtility.CreateLabel("Break Sequencer");
