...
{
    public class SameFamilyRuleNode : INode
    {
        protected override string DOCUMENTATION => "https://www.wlabsocks.com/wiki/index.php/Same_Family_Node";
        ...
        public override void Draw()
        {
            ...
            var inputPort = this.CreatePort("In", typeof(bool), Orientation.Horizontal, Direction.Input,
                Port.Capacity.Multi);
            inputPort.tooltip = "Checks whether Conspirator and Target are from the same family.";
            inputContainer.Add(inputPort);
                        
            var dualPort = this.CreatePort("[Dual]", typeof(bool), Orientation.Horizontal, Direction.Input,
                Port.Capacity.Multi);
            dualPort.tooltip = "Checks whether Primary Actor and Secondary Actor are from the same family.";
