...
{
    public class IsRelativeRuleNode : INode
    {
        protected override string DOCUMENTATION => "https://www.wlabsocks.com/wiki/index.php/Is_Relative_Node";
        ...
        public override void Draw()
        {
            ...
            inputPort.tooltip =
                "If the Conspirator and the Target are close relatives within the family (including: parents, grandparents, siblings, children, and grandchildren)";
            
            var dualPort = this.CreatePort("[Dual]", typeof(bool), Orientation.Horizontal, Direction.Input,
                Port.Capacity.Multi);
            dualPort.tooltip =
                "If the Primary Actor and the Secondary Actor are close relatives within the family (including: parents, grandparents, siblings, children, and grandchildren)";
