...
{
    public class SetConspiratorNode : INode
    {
        protected override string DOCUMENTATION => "https://www.wlabsocks.com/wiki/index.php/Set_Conspirator_Node";

        public string ConspiratorID;
