...
namespace Nullframes.Intrigues.Graph.Nodes
{
    ...
    {
        protected override string DOCUMENTATION => "https://www.wlabsocks.com/wiki/index.php/Set_Variable_Node";
        ...
        public override void Draw()
        {
            ...
            var titleLabel = IEGraphUtility.CreateLabel("<color=#80a35b>\u25CF</color> Set Variable");
