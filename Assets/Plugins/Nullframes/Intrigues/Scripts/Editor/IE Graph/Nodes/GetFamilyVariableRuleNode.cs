...
{
    public class GetFamilyVariableRuleNode : INode
    {
        protected override string DOCUMENTATION => "https://www.wlabsocks.com/wiki/index.php/Get_Family_Variable_Rule_Node";
        ...
        public override void Draw()
        {
            ...
            var actor = this.CreatePort("[Family]", typeof(bool), Orientation.Horizontal, Direction.Input,
                Port.Capacity.Multi);
            ...
            var titleLabel = IEGraphUtility.CreateLabel("<color=#CCC377>\u25CF</color> Get [Family] Variable");
