...
{
    public class IsChildRuleNode : INode
    {
        protected override string DOCUMENTATION => "https://www.wlabsocks.com/wiki/index.php/Is_Child_Node";
        ...
        public override void Draw()
        {
            ...
            conspirator.tooltip = "If the target is the child of the conspirator.";

            var target = this.CreatePort("Target", typeof(bool), Orientation.Horizontal, Direction.Input,
                Port.Capacity.Multi);
            inputContainer.Add(target);
            target.tooltip = "If the conspirator is the child of the target.";
            
            var dualPort = this.CreatePort("[Dual]", typeof(bool), Orientation.Horizontal, Direction.Input,
                Port.Capacity.Multi);
            dualPort.tooltip = "If the primary actor is the child of the secondary actor.";
