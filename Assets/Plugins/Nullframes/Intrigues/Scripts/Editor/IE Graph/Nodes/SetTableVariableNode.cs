...
{
    public class SetTableVariableNode : INode
    {
        protected override string DOCUMENTATION => "https://www.wlabsocks.com/wiki/index.php/Set_Table_Variable_Node";
        ...
        public override void Draw()
        {
            ...
            var titleLabel = IEGraphUtility.CreateLabel("<color=#80a35b>\u25CF</color> Set Variable<size=12> | Table");
            ...
            var index = mathField.choices.IndexOf(Operation.ToString());
            mathField.index = index == -1 ? 0 : index;
        ...
        {
            var variable = ((SchemeGroup)Group).Variables.FirstOrDefault(e => e.id == variableId);
            ...
            if (variable.type is NType.Bool)
                dropdownField.Show();
            else
                dropdownField.Hide();
        }
