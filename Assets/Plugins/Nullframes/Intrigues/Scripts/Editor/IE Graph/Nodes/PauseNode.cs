...
{
    public class PauseNode : INode
    {
        protected override string DOCUMENTATION => "https://www.wlabsocks.com/wiki/index.php/Pause_Node";
        ...
        {
            base.Draw();
            var titleLabel = IEGraphUtility.CreateLabel("Pause");
