...
{
    public class GetPolicyRuleNode : INode
    {
        protected override string DOCUMENTATION => "https://www.wlabsocks.com/wiki/index.php/Has_Policy_Node";
        ...
        public override void Draw()
        {
            ...
            policyList.AddClasses("ide-node__get-policy-dropdown-field");
