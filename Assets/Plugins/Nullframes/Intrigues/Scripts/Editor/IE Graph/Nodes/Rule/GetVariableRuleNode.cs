...
{
    public class GetVariableRuleNode : INode
    {
        protected override string DOCUMENTATION => "https://www.wlabsocks.com/wiki/index.php/Get_Variable_Node";
        ...
        public override void Draw()
        {
            ...
            var globalIn = this.CreatePort("Global", typeof(bool), Orientation.Horizontal, Direction.Input,
                Port.Capacity.Multi);
            inputBox.Add(globalIn);
            ...
            var titleLabel = IEGraphUtility.CreateLabel("<color=#CCC377>\u25CF</color> Get Variable");
