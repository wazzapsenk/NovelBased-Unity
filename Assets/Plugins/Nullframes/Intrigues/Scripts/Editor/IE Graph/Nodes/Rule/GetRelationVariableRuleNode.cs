...
{
    public class GetRelationVariableRuleNode : INode
    {
        protected override string DOCUMENTATION => "https://www.wlabsocks.com/wiki/index.php/Get_Relation_Variable";
        ...
        public override void Draw()
        {
            ...
            var titleLabel = IEGraphUtility.CreateLabel("<color=#CCC377>\u25CF</color> Get Relation Variable");
