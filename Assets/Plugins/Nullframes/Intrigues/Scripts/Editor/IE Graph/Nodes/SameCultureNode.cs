...
{
    public class SameCultureNode : INode
    {
        protected override string DOCUMENTATION => "https://www.wlabsocks.com/wiki/index.php/Same_Culture_Node";
        ...
        public override void Draw()
        {
            ...
            var inputPort = this.CreatePort("In", typeof(bool), Orientation.Horizontal, Direction.Input,
                Port.Capacity.Multi);
            inputPort.tooltip = "Checks whether Conspirator and Target are from the same culture.";
            inputContainer.Add(inputPort);
            
            var dualPort = this.CreatePort("[Dual]", typeof(bool), Orientation.Horizontal, Direction.Input,
                Port.Capacity.Multi);
            dualPort.tooltip = "Checks whether Primary Actor and Secondary Actor are from the same culture.";
            ...
            {
                var cPort = this.CreatePort(choice.Name, Port.Capacity.Multi);
                cPort.userData = choice;
