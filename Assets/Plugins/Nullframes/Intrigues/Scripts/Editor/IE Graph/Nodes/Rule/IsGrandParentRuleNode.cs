...
{
    public class IsGrandParentRuleNode : INode
    {
        protected override string DOCUMENTATION => "https://www.wlabsocks.com/wiki/index.php/Is_Grandparent_Node";
        ...
        public override void Draw()
        {
            ...
            conspirator.tooltip = "If the target is the grandparent of the conspirator.";

            var target = this.CreatePort("Target", typeof(bool), Orientation.Horizontal, Direction.Input,
                Port.Capacity.Multi);
            inputContainer.Add(target);
            target.tooltip = "If the conspirator is the grandparent of the target.";
            
            var dualPort = this.CreatePort("[Dual]", typeof(bool), Orientation.Horizontal, Direction.Input,
                Port.Capacity.Multi);
            dualPort.tooltip = "If the primary actor is the grandparent of the secondary actor.";
