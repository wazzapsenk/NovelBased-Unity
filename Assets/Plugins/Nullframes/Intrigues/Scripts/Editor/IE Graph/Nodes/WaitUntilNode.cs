...
namespace Nullframes.Intrigues.Graph.Nodes
{
    ...
    {
        protected override string DOCUMENTATION => "https://www.wlabsocks.com/wiki/index.php/Wait_Until_Node";
        ...
        public override void Draw()
        {
            ...
            var titleLabel = IEGraphUtility.CreateLabel("<color=#CCC377>\u25CF</color> Wait Until");
