...
{
    public class ResumeNode : INode
    {
        protected override string DOCUMENTATION => "https://www.wlabsocks.com/wiki/index.php/Resume_Node";
        ...
        {
            base.Draw();
            var titleLabel = IEGraphUtility.CreateLabel("Resume");
